...
export default function Card({ clicked, id, project_name, card_no, project_highlights }) {
    return (
        <div className={classes["card"]}>
            <div className={classes["card"]}>
                <div className={classes["card__side"] + " " + classes["card__side--front"]}>
                    <div className={classes["card__picture"] + " " + classes[`card__picture--${card_no}`]}>
                        &nbsp;
                    </div>
                    <h4 className={classes["card__heading"]} >
                        <span className={classes["card__heading-span"] + " " + classes[`card__heading-span--${card_no}`]}>
                            {project_name}
                        </span>
                    </h4>
