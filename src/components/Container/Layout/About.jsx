		...
		<section className={classes['section-about'] + ' ' + classes['container']}>
			<div className={classes['section-wrapper']} id='about'>
				...
				<p className={classes['long-copy']}>
					...
					<span className={classes.highlight}>fast, reliable, engaging & responsive websites powered</span>
					with efficient and modern backends.
					<br />
					<br />
					I`m a big fan of <span className={classes.highlight}>AGILE</span> Workflow, I use it`s
					collaborative, flexible and adaptive principles for indentifying scope for the product & evolve it
					by adding new business ideas, innovations and values that meet user needs as well as business
