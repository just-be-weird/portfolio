...
export default function About() {
  ...
  return (
    <div className="content_tracker">
      ...
      <section
        className={classes["section-about"] + " " + classes["container"]}
      >
        <div className={classes["section-wrapper"]} id={about}>
          <div className={section_about_intro}>
            ...
            <div
              className={
                classes["hero-text-box"] + " " + classes["heading-primary"]
              }
            >
              <h2
                className={
              ...
              <div className={classes["hero-text-box-container"]}>
                ...
                <p className={classes["heading-secondary"]}>
                  ...
                  <br />– Loves philoshphy and creates high-quality websites and
                  digital applications with knowledge and passion.
                </p>
              </div>
            </div>
          </div>
          <p
            className={classes["long-copy"] + " " + classes.section_about}
            id="description"
          >
            <span className={classes.highlight}>FullStack developer</span> at
            Nivoda LLP. Loves to bring up{" "}
            ...
            <br />
            <br />
            Big fan of <span className={classes.highlight}>AGILE</span>{" "}
            Workflow, uses it`s collaborative, flexible and adaptive principles
            for identifying scope for the product & evolve it by adding new
            business ideas, innovations and values that meet user needs as well
            as business objectives. Strongly focused on{" "}
            <span className={classes.highlight}>
              performance & responsive design{" "}
            </span>
            using the <span className={classes.highlight}>latest STACK</span>{" "}
            that meets the requirements of modern time.
          </p>
        </div>
      </section>
      <Experience />
