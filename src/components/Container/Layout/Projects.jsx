	...
	const data = [
		[
			...
			},
			{
				...
				project_data: {
					...
					title: 'The Vitamin Shoppe® | Vitamins, Supplements, Protein Powder & Keto Snacks',
		...
		[
			...
			},
			{
				...
				project_data: {
					description: 'This is my own portfolio developved and desgined by me.',
					title: 'My Portfolio',
	...
	return (
		<Fragment>
			...
			<Modal id='poroject' modalState={mstate} hideModal={hideModalHandler}>
				<h4 className={classes['section-subtitle'] + ' ' + classes['u-margin-bottom-small']}>
					{selectedCardstate.project_name}
				</h4>
				<h3 className={classes['heading-secondary'] + ' ' + classes['u-margin-bottom-small']}>
				...
				<div className={classes.popup__content__container}>
					...
					<div className={classes['popup__details']}>
						<p className={classes['popup__details-text']}>Technical Stack Details&ndash;</p>
						<ul>
